...
"-s" , "--subdomains" , help="File contain subdomains Ex: subs.txt",
metavar=""
)
parser_arg_menu.add_argument(
"-p", "--ip" , help="result ip only",
action="store_true"
)
parser_arg_menu.add_argument(
"-t", "--threads" , help="Thread number to MultiProccess [speed tool] , Default 500",
metavar=""
)
parser_arg_menu.add_argument(
...
max_threads = int(arg_menu.threads) if arg_menu.threads else int(500)
